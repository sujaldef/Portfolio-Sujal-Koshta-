...
const HeroSection = () => {
  ...
  const mouse = {
    x: useSpring(0, { stiffness: 50, damping: 20 }),
    y: useSpring(0, { stiffness: 50, damping: 20 }),
  };
  ...
  return (
    ...
    >
        ...
        >
          ...
          <RevealText className="mb-6">
            <div className="flex items-center gap-3 border border-[#C7B7A3]/20 w-fit px-4 py-2 rounded-full bg-[#2a0a10]/50 backdrop-blur-sm">
              ...
              <span className="text-xs font-mono uppercase tracking-widest text-[#C7B7A3]">
                Available for Hire
              </span>
            </div>
          </RevealText>
          ...
          <h1 className="text-[12vw] lg:text-[7rem] leading-[0.85] font-light tracking-tighter text-[#E8D8C4] mb-8 mix-blend-exclusion">
            ...
            <RevealText delay={0.2}>
              <span className="italic font-serif text-[#C7B7A3]">
                CRAFTSMAN
              </span>
            </RevealText>
          </h1>
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start border-t border-[#C7B7A3]/20 pt-8 max-w-2xl">
            <RevealText delay={0.4}>
              <p className="text-[#C7B7A3] text-lg leading-relaxed max-w-md">
                I am{' '}
                <span className="text-[#E8D8C4] font-semibold">
                  Sujal Koshta
                </span>
                . A Full-Stack Developer blending technical precision with
                artistic direction to build immersive web experiences.
              </p>
            </RevealText>
          ...
          <div className="flex gap-6 mt-12 text-[#C7B7A3]">
            {[
              ...
              {
                Icon: SiLeetcode,
                href: 'https://leetcode.com/u/Sujal_koshta/',
                label: 'LeetCode',
              },
            ].map(({ Icon, href, label }) => (
              <Magnetic key={label} strength={0.2}>
                <a
                  ...
                  rel="noreferrer"
                  aria-label={label}
                  className="hover:text-[#E8D8C4] transition-colors p-2"
                >
                  <Icon size={24} />
                </a>
              </Magnetic>
          ...
          <div className="relative w-full max-w-[450px] aspect-[3/4]">
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 bg-[#2a0a10]/80 backdrop-blur-md rounded-xl border border-[#C7B7A3]/10 flex justify-between items-center">
                <div>
                  <p className="text-[10px] text-[#C7B7A3] uppercase tracking-widest">
                    Current Location
                  </p>
                  <p className="text-sm text-[#E8D8C4] font-medium">
                    Indore, India
                  </p>
                </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 mix-blend-difference">
        <span className="text-[10px] uppercase tracking-[0.3em] text-[#E8D8C4]">
          Scroll
        </span>
