...
const ProjectsInteractive = () => {
  ...
  // Filter Data by internship type and category
  const recentInternships = projectsData.filter((p) => p.isRecent === true);
  const firstInternship = projectsData.filter(
    (p) => p.internshipTitle === 'First Internship',
  );
  const personalProjects = projectsData.filter(
    (p) => p.category === 'Personal Project',
  );
  ...
  return (
    <section className="bg-[#2a0a10] text-[#E8D8C4] py-24 px-6 md:px-12 w-full relative border-t border-[#C7B7A3]/10">
      {/* --- SECTION 1: RECENT INTERNSHIP (ZENVOYAGER) --- */}
      <div className="max-w-[1400px] mx-auto mb-32">
        ...
        {/* Wide Cards Layout for Recent Internships */}
      ...
      {/* --- SECTION 2: FIRST INTERNSHIP (47BILLION) --- */}
      <div className="max-w-[1400px] mx-auto mb-32">
        <div className="flex flex-col md:flex-row items-end justify-between mb-12 border-b border-[#C7B7A3]/10 pb-6">
          <div>
            <div className="flex items-center gap-3 mb-3">
        ...
        {/* Wide Cards Layout for First Internship */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      {/* --- SECTION 3: PERSONAL PROJECTS (GRID) --- */}
    ...
    >
      ...
      <div className="relative h-[250px] w-full overflow-hidden">
        ...
        <div className="absolute bottom-6 left-6 right-6">
          <h3 className="text-3xl font-serif text-[#E8D8C4] mb-2">
            {project.title}
          </h3>
    ...
    >
      ...
      <div className="p-5">
        <div className="flex justify-between items-start mb-2">
          <h4 className="text-lg font-medium text-[#E8D8C4] line-clamp-1">
            {project.title}
          </h4>
          <GoArrowUpRight className="text-[#C7B7A3] opacity-0 group-hover:opacity-100 transition-all duration-300" />
        </div>
        <p className="text-[#C7B7A3]/60 text-xs line-clamp-2 mb-3">
          {project.shortDescription}
        </p>
      ...
      <div className="p-8 pb-4 border-b border-[#C7B7A3]/10 flex-shrink-0">
        <div className="flex justify-between items-start">
          <div>
            ...
            {project.dateRange && (
              <p className="text-[#C7B7A3]/70 text-xs font-mono mb-2">
                {project.dateRange}
              </p>
            )}
          ...
          >
            ...
            <div className="p-6 bg-[#2a0a10] rounded-xl border border-[#C7B7A3]/10 mt-6">
              ...
              <div className="flex gap-3">
                ...
                <p className="text-[#E8D8C4] italic text-base">
                  "{project.impact}"
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="grid grid-cols-1 gap-4">
                {project.details.map((detail, i) => (
                  ...
                  >
                    <FaCheckCircle
                      className="text-[#E8D8C4] shrink-0 mt-0.5"
                      size={14}
                    />
                    {detail}
                  </li>
