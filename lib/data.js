...
export const projectsData = [
  ...
  // --- EXTRA PROJECTS (Referenced in ProjectsSection) ---
  {
    id: 'sphere-1',
    category: 'Personal Project',
    ...
    title: 'SphereTest',
    shortDescription:
      'Full-stack live testing platform with Socket.io, real-time leaderboards and multi-type questions.',
    details: [
      'Admin/teacher creates spheres (rooms) and students join via game code.',
      'Real-time session lifecycle powered by Socket.io: start, submit, leaderboard, end.',
      'Backend: Node.js, Express, MongoDB, JWT; Frontend: React, Tailwind, Framer Motion.',
    ],
    impact: 'Enables synchronous assessments with live rankings and analytics.',
  ...
  },
  {
    ...
    title: 'OpenRepo',
    shortDescription:
      'AI-powered code analysis backend: static analysis, ML predictions, and LLM recommendations.',
    details: [
      'FastAPI backend for code analysis and RAG-enabled LLM recommendations.',
      'Static analyzers + ML predictors for code quality scoring and PR insights.',
      'Embeddings + FAISS for repository-aware contextual retrieval.',
    ],
    impact:
      'Automates code review insights and helps prioritize risky changes.',
    tech: ['Python', 'FastAPI', 'ML', 'FAISS'],
  ...
  },
  {
    ...
    title: 'ADIA',
    shortDescription:
      'Autonomous Data Intelligence Agent: orchestrates LLM plans and deterministic tools for analytics.',
    details: [
      'ReAct orchestrator that plans calls to SQL, insight, viz and RAG tools.',
      'FastAPI + LangChain-style orchestration with tool execution tracing.',
      'Conversational memory and FAISS-backed retriever for context-aware answers.',
    ],
    impact:
      'Provides actionable, tool-backed analytics answers for business users.',
    tech: ['Python', 'FastAPI', 'LangChain', 'Pandas'],
    images: ['skill7.png'],
    liveLink: '',
    githubLink: '',
  },
